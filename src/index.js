        ...
        <div class="col-6">
          <div class="row ps-3 pt-2">
            <div class="col-1 ps-2 pe-0 pt-2">
              <img id="img-msg" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWE9Em67nYEJTQaiaDfPIE-OygGi1H5H-byA&usqp=CAU" class="img-fluid rounded-circle border border-warning border-2" alt="imageBot"/>
            </div>
            <div class="col-11">
              <div class="card m-2">
                <div class="card-header">
                  <div class="row">
                    <div class="col-9 pt-2">Nom Bot 1</div>
                  </div>
                </div>
                <div class="card-body">
                  <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
        ...
        <div class="row">
          <div class="col-12 pt-2">
            <form class="row g-3">
              ...
              <div class="col-2">
                <button id="btnEnvoie" type="button" class="btn btn-primary mb-3">Envoyez</button>
              </div>
            </form>
          </div>
        </div>
    ...
    return `
      <div data-id=${id} class="row m-1">
        <div class="col-4 my-1">
          <img id="img-list" src="${avatar}" class="img-fluid rounded-circle border border-info border-2" alt="${name}"/>
        </div>
